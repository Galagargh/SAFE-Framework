<template>
  <section class="relative">
    ...
    <!-- Dark background -->
    <div class="absolute inset-0 bg-green-500 pointer-events-none -z-10 h-1/3 lg:h-[48rem] [clip-path:polygon(0_0,_5760px_0,_5760px_calc(100%_-_352px),_0_100%)]" aria-hidden="true"></div>
