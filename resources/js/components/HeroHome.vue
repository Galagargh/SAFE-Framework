<template>
  <section class="relative">
    ...
    <!-- Dark background -->
    <div class="absolute inset-0 bg-blue-400 pointer-events-none -z-10 [clip-path:polygon(0_0,_5760px_0,_5760px_calc(100%_-_352px),_0_100%)]" aria-hidden="true"></div>

    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-20 md:pt-40 md:pb-44">

        <!-- Hero content -->
        <div class="max-w-xl mx-auto md:max-w-none md:flex md:items-center space-x-8 -space-y-16">

<!--            md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-16 md:space-y-0-->

          <!-- Content -->
          <div class="text-center md:text-left md:min-w-[30rem]" data-aos="fade-right">
            <h1 class="h1 font-satoshi font-black text-slate-100 mb-4">Hello There!</h1>
